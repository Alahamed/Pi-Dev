        ...
        if (event.getSource() == btnSignin) {
            ...
            if (logIn().equals("Success")) {
                ...
                try {
                    ...
                    stage.close();
                    Scene scene = new Scene(FXMLLoader.load(getClass().getResource("../gui/HomeAdmin.fxml")));
    ...
    public void handleButtonSignup(MouseEvent event) {
        if (event.getSource() == btnSignup){
            try {
                ...
                //stage.setMaximized(true);
                stage.close();
                Scene scene = new Scene(FXMLLoader.load(getClass().getResource("../gui/Formulaire.fxml")));
